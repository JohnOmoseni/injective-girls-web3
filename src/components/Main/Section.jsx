  ...
  return (
    <div className="w-full min-h-[80vh] relative overflow-hidden  bg-gradient-100">
      <div className="md:w-[60%] max-sm:pt-16 pt-[10%] sm:pl-[5%] grid place-items-center">
        <h1 className="w-full max-md:text-center text-cyan-400 font-allura leading-[60px] md:leading-[70px] md:text-8xl text-shadow-200 dp-shad select-none break-words max-sm:px-3">
        ...
        <div className="w-full flex-row !flex-wrap md:flex-column mx-auto max-sm:px-6 gap-4 mt-12 mb-4">
          ...
          >
            <Button
              title="Discord"
              className="md:!w-[300px] bg-[#00fefb] py-3.5 px-6 rounded-sm border border-solid border-br-blue text-xl shadow-md"
